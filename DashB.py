...
if box == "Home":
    st.image(
        "https://img.freepik.com/premium-photo/stock-market-forex-trading-graph-graphic-concept_73426-102.jpg?w=2000")
    st.write(
        "******On this Stock Indices Prediction App, you can predict the future 5 years of stock index which is listed on their respective Stock exchange..******")
